    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-thin text-gray-900 dark:text-white tracking-wide">Create account</h2>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300 font-light">
            Join us for exclusive luxury collections
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 premium-shadow-lg rounded-lg elegant-shadow p-8 luxury-border">
          ...
          <form onSubmit={handleEmailRegister} className="space-y-6">
            ...
            <Button 
              type="submit" 
              className="w-full gold-gradient text-black hover:opacity-90 font-medium"
              disabled={isLoading}
            >
